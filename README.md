...
<br>👉Para ver el paso a paso de la implementación, entrenamiento y testeo del modelo de **MachinLearning** ver el archivo:  [ModeloML](/Proyecto-Individual-I/ModeloML.ipynb)
